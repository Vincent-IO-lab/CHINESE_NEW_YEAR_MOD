...
public class ModPointTagProvider extends TagProvider<PointOfInterestType> {
    ...
    protected void configure(RegistryWrapper.WrapperLookup lookup) {
        getOrCreateTagBuilder(PointOfInterestTypeTags.ACQUIRABLE_JOB_SITE)
                .addOptional(Identifier.of(TutorialMod.MOD_ID, "flour_miller_point_of_interest"))
                .addOptional(Identifier.of(TutorialMod.MOD_ID, "fortune_giver_point_of_interest"));
    }
}
